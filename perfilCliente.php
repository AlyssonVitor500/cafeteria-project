...
<body>
	<nav id="menuHeader" class="navbar navbar-expand-lg navbar-light bg-brown">
		...
		<div class="container-fluid" style="background-image: url(img/copoDeCafeWall.jpg); background-attachment: fixed; background-position: 50% 50%; padding-bottom: 10vh; padding-top: 10vh;">
			<h1 style="color: white; text-align: center; font-family: Lovelique; font-size: 15vh"  >Dados do Cliente <i class="fas fa-user fa-2x" style="color: white;"></i></h1>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-6"><a href="alterL.php?id=<?php echo $id;?>" style="width: 100%;" class="btn btn-warning btn-lg">Alterar dados da Conta</a></div> 
						<div class="col-md-6"><a href="deleteConfirmL.php?id=<?php echo $id;?>" style="width: 100%;" class="btn btn-danger btn-lg">Deletar Conta</a></div> 
					</div>
					<div class="row mt-3" >
						<div class="col-md-12">
							<div class="col-md-12"><a href="desloga.php" style="width: 100%;" class="btn btn-info btn-lg">Deslogar da Conta</a></div>
						</div>
					</div>
				</div>
