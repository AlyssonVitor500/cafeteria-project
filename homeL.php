...
<body>
	<nav id="menuHeader" class="navbar navbar-expand-lg navbar-light bg-brown">
		...
		<div class="container-fluid" style="background-image: url(img/cafe3.jpg); height: 80vh; background-attachment: fixed; margin-bottom: 5%; background-size: cover; background-position: 50% 50%;padding-top: 15%;">

			<h1 style="font-family: Lovelique; font-size: 20vh; text-align: center; color: white;" > Cafeteria Bom Sabor! </h1>			
		</div>
		
			
			<h1 style="font-family: Lovelique; font-size: 20vh; text-align: center" > O Melhor do Café para Você! </h1>
			
		 <div class="container-fluid" style="background-image: url(img/fotoCofe2.jpg); height: 80vh; background-attachment: fixed; margin-top: 5%; background-size: cover; background-position: 50% 50%;padding-top: 5%;">	

		 	<h1 style="font-family: Lovelique; font-size: 20vh; text-align: center; color: white;" >Veja seu Perfil! </h1>
		 	<div class="container">
		 		<a href="perfilCliente.php?email=<?php echo $email; ?>" class="btn btn-success btn-lg" style="width:100%; font-size: 10vh;font-family: Lovelique; color: white; margin: auto;">Visitar Perfil <i  class="fas fa-user-users fa-sm" style="color: white;"></i></a>
		 	</div>			
		</div>
		<h1 style="font-family: Lovelique; font-size: 20vh; text-align: center" >Quer deslogar? </h1>
		<div class="container">
			<a href="desloga.php" class="btn btn-warning btn-lg" style="width:100%; font-size: 10vh;font-family: Lovelique; color: white; margin: auto;">Deslogar <i  class="fas fa-user-plus fa-sm" style="color: white;"></i></a>
		</div>
