...
<body>
		...
		<div class="content-fluid center" style="background-image: url('img/coffeWallpaper.jpg'); height: auto; padding-bottom: 10vh; background-attachment: fixed; background-position: 30% 50%">
				...
				<div class="content">
					<form method="post" action="alterarL.php?id=<?php echo $id;?>" class="form-group">
						
					<div class="container center">
					<table class="">
						<tr>
							<td colspan="2" align="center" style="font-size: 30pt"><i  class="fas fa-user-edit fa-2x" style="color: white;"></i>Alteração de Cliente</td>
						</tr>
						<tr>
						...
						<tr><td colspan="2" align="center"><input value="<?php echo $senha; ?>" type="password" id="senha" class="form-control" name="senhaTxt" required=""><i onclick="senhaMostrarNaoMostrar()" class="fas fa-eye" id="olhoSenha"></i><span class="label">&nbsp;&nbsp;Ex: 888975564</span></td></tr>
						...
						<tr>
							<td align="center"><input type="submit" value="Alterar" style="width: 100%;" class="btn btn-success" width="60%" name=""></td><td align="center"><a href="perfilCliente.php?email=<?php echo $email; ?>" style="width: 100%;"  width="60%" class="btn btn-warning" name="">Cancelar</a>
						</tr>
					</table>
					</div>
				</form>
