	...
	<div id="corpo">
		...
		<nav id="menuHeader" class="navbar navbar-expand-lg navbar-light bg-brown">
			  ...
			  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation" >
			    <span onclick="menu2()" class="navbar-toggler-icon"></span>
			  </button>
		...
		<div class="content-fluid center" style="background-image: url('img/coffeWall2.jpg'); height: auto; padding-bottom: 10vh; background-attachment: fixed; background-position: 30% 50%">

				<div class="content">
					<form method="post" action="logar.php" class="form-group">
						
					<div class="container center">
					<table class="">
						<tr>
							<td colspan="2" align="center" style="font-size: 7vh">Login<i  class="fas fa-users fa-2x" style="color: white;"></i></td>
						</tr>
						...
						<tr><td colspan="2" align="center"><input type="email" id="email" class="form-control" name="email" required=""><span class="label">Ex: lucasazevedo@gmail.com</span></td></tr>
						<tr>
							<td colspan="2" align="center"><label for="email"><label for="senha">Senha</label></td>
						</tr>
						<tr><td colspan="2" align="center"><input type="password" id="senha" class="form-control" name="senha" required=""><i onclick="senhaMostrarNaoMostrar()" class="fas fa-eye" id="olhoSenha"></i><span class="label">&nbsp;&nbsp;Ex: 888975564</span></td></tr>
						
							<td align="center"><input type="submit" value="Logar" class="btn btn-success btn-lg" style="width: 100%" name=""></td><td align="center"><input type="reset" value="Cancelar"  style="width: 100%" class="btn btn-danger btn-lg" name=""></td>
						</tr>
						<tr>
							<td style="color: grey" colspan="2" align="center"><i style=" font-size: 2.5vh;">Ainda não se cadastrou?</i> <a href="cadastrarCliente.php" class="btn btn-info btn-sm">Cadastre-se</a></td>
						</tr>
						<tr>
							<td colspan="2">
									<?php 
										@$chave = $_GET['num']; 
										if($chave == 1) {
											echo "<span style='width: 100%;' class='btn btn-warning btn-lg'> Os valores informados estão incorretos </span>";
										} 
									?>
		...
		<footer class="footer" style="background-color: white; font-family: Champagne;border-top: 1px solid orange;">
...
<script type="text/javascript">
		...
		function senhaMostrarNaoMostrar() {
			if (x==1) {
