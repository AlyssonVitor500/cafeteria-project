<?php 
	...
	@$email = $_GET['email'];
	include_once 'conseguirDados2.php';
...
<body>
	<nav id="menuHeader" class="navbar navbar-expand-lg navbar-light bg-brown">
		...
		<div class="container" style="padding-top: 5%;">
			...
			<a href="homeL.php?email=<?php echo $email; ?>"" class="btn btn-info btn-lg" style="width:100%"><i class="fas fa-angle-double-left fa-lg" style="color: white"></i>Retornar ao Home</a>
		</div>
		...
		<div class="container" style="margin-top: 5%; font-family: Champagne;">
					...
					<div class="row">
						...
						<div class="col-md-12">
							<form class="form-group" method="post" action="coment.php?id=<?php echo $id; ?>">
								
							
								<textarea class="form-control" id="textAr" placeholder="Deixe sua opnião para nós" style="resize: none; border: 1px solid rgba(139,69,19,1);outline: none; width: 100%; height: 20vh" name="text"></textarea>
