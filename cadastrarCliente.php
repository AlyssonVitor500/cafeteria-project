...
<body>
		...
		<div class="content-fluid center" style="background-image: url('img/coffeWallpaper.jpg'); height: auto; padding-bottom: 10vh; background-attachment: fixed; background-position: 30% 50%">
				...
				<div class="content">
					...
					<table class="">
						<tr>
							<td colspan="2" align="center" style="font-size: 30pt"><i  class="fas fa-user-plus fa-2x" style="color: white;"></i>Cadastro de Cliente</td>
						</tr>
						<tr>
							<td colspan="2" align="center"><label for="nameTxt">Nome</label></td>
						</tr>
						<tr>
							<td colspan="2" align="center"><input type="text"  id="nameTxt" class="form-control"  name="nomeTxt" required=""><span class="label">Ex: Lucas Azevedo</span></td>
						</tr>
						<tr>
							<td colspan="2" align="center"><label for="fone">Telefone</label></td>
						</tr>
						<tr><td colspan="2" align="center"><input type="text" class=" form-control" id="fone" name="telTxt" required=""><span class="label">Ex: (DD) 90000-0000</span></td></tr>
						<tr>
							<td colspan="2" align="center"><label for="email"><label for="email">Email</label></td>
						</tr>
						<tr><td colspan="2" align="center"><input type="email" id="email" class="form-control" name="emailTxt" required=""><span class="label">Ex: lucasazevedo@gmail.com</span></td></tr>
						<tr>
							<td colspan="2" align="center"><label for="email"><label for="senha">Senha</label></td>
						</tr>
						<tr><td colspan="2" align="center"><input type="password" id="senha" class="form-control" name="senhaTxt" required=""><i onclick="senhaMostrarNaoMostrar()" class="fas fa-eye" id="olhoSenha"></i><span class="label">&nbsp;&nbsp;Ex: 888975564</span></td></tr>
					
						<tr>	
							<td colspan="2" align="center"><label for="date">Data de Nascimento</label></td>
						</tr>
						<tr><td colspan="2" align="center"><input type="date" name="dataTxt"  class="form-control" id="date" required=""><span class="label">Ex: 12/12/2002</span></td></tr>
						<tr>
							<td align="center"><input type="submit" value="Enviar Valores" class="btn btn-success" width="60%" name=""></td><td align="center"><input type="reset" value="Resetar Valores" width="60%" class="btn btn-warning" name=""></td>
						</tr>
							...
							<?php 
								@$a = $_GET['bo'];
								 if($a == 1){
									echo "
										<tr>
											<td colspan='2'><span class='btn btn-danger btn-lg' style='width:100%;'>Dados já utilizados, por favor, tente novamente!</span>
										</tr>	
