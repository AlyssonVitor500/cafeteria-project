	...
	<nav id="menuHeader" class="navbar navbar-expand-lg navbar-light bg-brown">
		...
		<div class="container-fluid" style="background-image: url(img/cafe3.jpg); height: 80vh; background-attachment: fixed; margin-bottom: 5%; background-size: cover; background-position: 50% 50%;padding-top: 15%;">
		 ...
		 <div class="container-fluid" style="background-image: url(img/fotoCofe2.jpg); height: 80vh; background-attachment: fixed; margin-top: 5%; background-size: cover; background-position: 50% 50%;padding-top: 5%;">	
		 	...
		 	<h1 style="font-family: Lovelique; font-size: 20vh; text-align: center; color: white;" > Faça seu Login Já! </h1>
		 	<div class="container">
		 		<a href="logarCliente.php" class="btn btn-success btn-lg" style="width:100%; font-size: 10vh;font-family: Lovelique; color: white; margin: auto;">Fazer Login <i  class="fas fa-user-users fa-sm" style="color: white;"></i></a>
		 	</div>			
		</div>
		<h1 style="font-family: Lovelique; font-size: 20vh; text-align: center" >Ainda não se Cadastrou? </h1>
		<div class="container">
			<a href="cadastrarCliente.php" class="btn btn-warning btn-lg" style="width:100%; font-size: 10vh;font-family: Lovelique; color: white; margin: auto;">Cadastre-se <i  class="fas fa-user-plus fa-sm" style="color: white;"></i></a>
		</div>
